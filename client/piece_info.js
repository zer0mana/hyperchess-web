class PieceInfo {
    infos= {
        ...
        "a": {pieceImage: "url('img/pieces/T_Assasin.png')", pieceName: "Ассасин", pieceDescription: "Двигается на 2 клетки в любом направлении. Если его съедает фигура, то она тоже убирается с доски. Не проходит сквозь фигуры."},
        "f": {pieceImage: "url('img/pieces/T_Freez.png')", pieceName: "Фриз", pieceDescription: "Двигается как конь. Не может есть фигуры. Фигуры противника в зоне атаки не могу двигаться. Проходит сквозь фигуры."},
        "s": {pieceImage: "url('img/pieces/T_Spades.png')", pieceName: "Пикинер", pieceDescription: "Двигается на две клетки в любом направлении. Съедат фигуру на расстоянии равном его ходу. Не проходит сквозь фигуры."},
        "g": {pieceImage: "url('img/pieces/T_Boomerang.png')", pieceName: "Бумеранг", pieceDescription: "Двигается по диагонали, один раз может оттолкнуться от объекта и продолжить движение. Не может есть фигуры, пока не оттолкнулся. Не проходит сквозь фигуры."},
        "j": {pieceImage: "url('img/pieces/T_Kamikaze.png')", pieceName: "Ниндзя", pieceDescription: "Двигается вперед как ферзь. Не проходит сквозь фигуры."},
        "d": {pieceImage: "url('img/pieces/T_Spider.png')", pieceName: "Павук", pieceDescription: "Двигается на две клетки в любом направлении. Имеет зону контроля. Не проходит сквозь фигуры."},
        "m": {pieceImage: "url('img/pieces/T_Admiral.png')", pieceName: "Адмирал", pieceDescription: "Двигается 4 клетки по горизонтали, а затем еще 3 по вертикали. Может остановиться на любой из них. Не проходит сквозь фигуры."},
        "l": {pieceImage: "url('img/pieces/T_Dolphin.png')", pieceName: "Дельфин", pieceDescription: "Двигается на 3 клетки по горизонтали или вертикали. Проходит сквозь фигуры."},
